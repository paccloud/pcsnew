 ...
 * Slug: pcs-twentytwentyfive-child/footer
 * Categories: footer
 * Block Types: core/template-part/footer
 * Description: Footer with logo, title, tagline and navigation links to existing pages.
 *
 * @package PCS_Twenty_Twenty_Five_Child
 * @subpackage Pacific Cloud Seafoods
 */
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group alignfull">
			...
			<p class="has-small-font-size">
				Sustainably sourced seafood from Alaska to Buffalo
			</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->

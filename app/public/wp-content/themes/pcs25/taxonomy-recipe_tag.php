<?php
/**
 * The template for displaying recipe tag taxonomy archives
 *
...
<header class="page-header alignwide">
	<h1 class="page-title">Recipes Tagged: <?php echo esc_html( $term->name ); ?></h1>
...
<?php if ( have_posts() ) : ?>
	...
	<div class="no-results">
		...
		<p>Sorry, but no recipes were found with this tag.</p>
	</div>
	<?php
endif;

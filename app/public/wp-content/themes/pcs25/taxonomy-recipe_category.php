<?php
/**
 * The template for displaying recipe category taxonomy archives
 *
...
<header class="page-header alignwide">
	<h1 class="page-title"><?php echo esc_html( $term->name ); ?> Recipes</h1>
...
<?php if ( have_posts() ) : ?>
	...
	<div class="no-results">
		...
		<p>Sorry, but no recipes were found in this category.</p>
	</div>
	<?php
endif;
